...
#5.) Given this nested Hash, figure out the toal age of just the male members of the family. 
...
munsters.each do |_,v|
  age_total += v['age'] if v['gender'] == 'male'
end
p age_total
